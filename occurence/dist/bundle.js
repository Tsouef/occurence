...
var Occurence = function () {
    function Occurence(text) {
        _classCallCheck(this, Occurence);

        this.occurenceText(text);
    }

    _createClass(Occurence, [{
        key: 'occurenceText',
        value: function occurenceText(text) {
